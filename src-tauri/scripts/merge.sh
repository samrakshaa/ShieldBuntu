  ...
  for option in $(echo "$@" | tr ' ' '\n' | sort -n); do
    case $option in
      0)
        ...
        merged_script+="$(cat formerge/main/level1/apparmor.sh)\n"
        merged_script+="sleep 2 )\n\n"
        ;;
      1)
        merged_script+="\n\n( sleep 2 && echo -e '================= Check Sudo Users ========='\n"
        merged_script+="$(cat formerge/main/level1/checksudo.sh)\n"
        merged_script+="sleep 2 )\n\n"
        ;;
      2)
        merged_script+="\n\n( sleep 2 && echo -e '================= Firewall Config =========='\n"
        merged_script+="$(cat formerge/main/level2/firewall.sh)\n"
        merged_script+="sleep 2 )\n\n"
        ;;
      3)
        merged_script+="\n\n( sleep 2 && echo -e '================= USB Block ===================='\n"
        merged_script+="$(cat formerge/main/level2/usbblock.sh)\n"
        merged_script+="sleep 2 )\n\n"
        ;;
      4)
        merged_script+="\n\n( sleep 2 && echo -e '================= SSH Hardening ==============='\n"
        merged_script+="$(cat formerge/main/level2/ssh.sh)\n"
        merged_script+="sleep 2 )\n\n"
        ;;
      5)
        merged_script+="\n\n( sleep 2 && echo -e '================= Tor Port Block =============='\n"
        merged_script+="$(cat formerge/main/level1/tor.sh)\n"
        merged_script+="sleep 2 )\n\n"
        ;;
      6)
        merged_script+="\n\n( sleep 2 && echo -e '================= Audits =============='\n"
        merged_script+="$(cat formerge/main/level1/audit.sh)\n"
        merged_script+="sleep 2 )\n\n"
        ;;
      7)
        merged_script+="\n\n( sleep 2 && echo -e '================= User Access Control =============='\n"
        merged_script+="$(cat formerge/main/level1/uac.sh)\n"
        merged_script+="sleep 2 )\n\n"
        ;;
      8)
        merged_script+="\n\n( sleep 2 && echo -e '================= Grub Password ============'\n"
        merged_script+="$(cat formerge/main/level2/grubpass.sh)\n"
        merged_script+="sleep 2 )\n\n"
        ;;
      9)
        merged_script+="\n\n( sleep 2 && echo -e '================= Kernel Hardening ========='\n"
        merged_script+="$(cat formerge/main/level2/kernel.sh)\n"
        merged_script+="sleep 2 )\n\n"
        ;;
      10)
        merged_script+="\n\n( sleep 2 && echo -e '================= Remove(mask) unused packages =='\n"
        merged_script+="$(cat formerge/main/level2/rmorphan.sh)\n"
        merged_script+="sleep 2 )\n\n"
        ;;
      11)
        merged_script+="\n\n( sleep 2 && echo -e '================= /tmp /var file permission =='\n"
        merged_script+="$(cat formerge/main/level2/noexec.sh)\n"
        merged_script+="sleep 2 )\n\n"
        ;;
      12)
        merged_script+="\n\n( sleep 2 && echo -e '================= Core Dump Collection =='\n"
        merged_script+="$(cat formerge/main/level2/coredump.sh)\n"
        merged_script+="sleep 2 )\n\n"
        ;;
      *)
