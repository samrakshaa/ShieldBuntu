...
#[allow(non_snake_case)]
#[tauri::command]
pub async fn reverse_usb_blocking(handle:AppHandle, usbIds: Vec<String>) -> Result<String, String> {
    let password = get_password().ok_or_else(|| "Password not available".to_string())?;
    // let current_dir = std::env::current_dir().map_err(|e| format!("Error getting current directory: {}", e))?;
    // let script_path = current_dir.join("scripts/reverse/r-usb_blocking.sh");
    // let log_file_path = current_dir.join("logs/reverse_usb_blocking_log.txt");
...
#[allow(non_snake_case)]
#[tauri::command]
pub async fn whitelist_usb(handle: AppHandle,usbIds: Vec<String>) -> Result<String, String> {
    let password = get_password().ok_or_else(|| "Password not available".to_string())?;
    // let current_dir = std::env::current_dir().map_err(|e| format!("Error getting current directory: {}", e))?;
...
#[allow(non_snake_case)]
#[tauri::command]
pub async fn blacklist_usb(handle: AppHandle, usbIds: Vec<String>) -> Result<String, String> {
    let password = get_password().ok_or_else(|| "Password not available".to_string())?;
    // let current_dir = std::env::current_dir().map_err(|e| format!("Error getting current directory: {}", e))?;
